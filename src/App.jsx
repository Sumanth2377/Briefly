        ...
        <div className="px-8 py-6 border-b border-white/5 flex flex-col gap-4 bg-[#050505] z-20">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-white/[0.03] border border-white/[0.06] rounded-lg pl-9 pr-9 py-2 text-xs text-slate-300 placeholder-slate-600 focus:outline-none focus:border-indigo-500/40 focus:bg-white/[0.05] transition-all"
            />
            {searchQuery && (
              <button
